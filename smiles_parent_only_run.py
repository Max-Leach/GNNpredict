...
# NOTE: update for public use and create batched version to increase efficiency (like mol -> multiple bonds or use a set to reduce graphs)

# reac_sm = 'COc1ccc(NC=O)c(C(=O)CCNC(C)=O)c1'
...
def predict(reac_sm, broken_bond_idx):
