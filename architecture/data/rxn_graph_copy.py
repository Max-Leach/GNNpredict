...
def generate_nsppk_features(smiles_list, data, params):
    """
    Returns dense torch tensor of NSPPK features (one row per graph).
    """
    X_graphs = smiles_list.apply(smiles_to_graph)
    X_sparse = extract_features(X_graphs, data, **params)
