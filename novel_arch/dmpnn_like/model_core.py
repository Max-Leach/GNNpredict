...
class GatedGCNMolCustomConv(nn.Module):
    """
    Gated graph neural network model to predict molecular property. From BondNet paper.

    Adapted from GatedGCNMol, but convolution operation can be inserted.
