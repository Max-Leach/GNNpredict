## this architecture will use largely bondnet's base
# -however, the g2g module will be more D-MPNN-like (as in Grambow paper), 
# where node features do not exist, and bonds are now represented by two directed edges in opposing directions
# global state will remain, and will be updated after edge update
...
import dgl
import torch
from novel_arch.dmpnn_1.model_core import GatedGCNMolCustomConv
from novel_arch.dmpnn_1.directed_graph_transform import to_directed_mpnn_g
from novel_arch.dmpnn_1.to_dmpnn_features import GrambowFeaturizer
