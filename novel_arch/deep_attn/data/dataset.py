...
class BDEDataset(Dataset):
    def __init__(self, dsr: DirectSmilesRepo, bdemap: DGLwBDEMappings):
        super().__init__()
    ...
    def __getitem__(self, idx):
        ...
        r_p_graph_ref = ([0], [1, 2]) # doesn't change due to fixed way graphs are aggregated above
        # NOTE: create feature aggregation so we can use directly below
        # return graphs, self.feats[idx], self.rxn_feat_gens[idx], r_p_graph_ref
        return graphs, None, self.rxn_feat_gens[idx], r_p_graph_ref
