...
# this may be flawed, but for small graph it would appear that in, out degree pairs should match
...
def test_to_directed_mpnn_g_isomorphism():
    ...
    # following doesn't actually effect result (atm!) because its already assumed
    # that all nodes attach to global
    g2b = ([0,0,0], [0,1,2])
    g2a = ([0,0,0,0], [0,1,2,3])
