...
def main():
    ...
    # Concatenate
    X_fused_train = sparse_safe_concat(Xg_train_norm, Xn_train_norm)
    X_fused_test = sparse_safe_concat(Xg_test_norm, Xn_test_norm)
    X_fused_val = sparse_safe_concat(Xg_val_norm, Xn_val_norm)
